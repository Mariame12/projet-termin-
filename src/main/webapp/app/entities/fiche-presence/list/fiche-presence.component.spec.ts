...
describe('Component Tests', () => {
  describe('FichePresence Management Component', () => {
    let comp: FichePresenceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FichePresenceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.fichePresences[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
